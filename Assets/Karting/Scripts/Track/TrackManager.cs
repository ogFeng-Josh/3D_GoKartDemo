...
namespace KartGame.Track
{
    ...
    public class TrackManager : MonoBehaviour
    {
        ...
        private particleTrigger particleTrigger;
        private startAI _startAI;
        ...
        void Start()
        {
            particleTrigger = FindObjectOfType<particleTrigger>();

            _startAI = FindObjectOfType<startAI>();
            ...
            if (checkpoint.isStartFinishLine)
            {
                ...
                if (racerCurrentLap > 0)
                {
                    ...
                    if (racerCurrentLap == raceLapTotal)
                    {
                        ...
                        particleTrigger.TriggerParticles();
                        racer.DisableControl();
                        racer.PauseTimer();
                    }
                }
