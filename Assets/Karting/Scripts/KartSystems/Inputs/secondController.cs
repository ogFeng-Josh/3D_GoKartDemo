...
namespace KartGame.KartSystems
{
    ...
    /// </summary>
    public class secondController : MonoBehaviour, IInput
    {
        ...
        void Update()
        {
            ...
            m_HopHeld = Input.GetKey(KeyCode.Period);
            ...
            m_HopPressed |= Input.GetKeyDown(KeyCode.Period);
            m_BoostPressed |= Input.GetKeyDown(KeyCode.RightShift);
            m_FirePressed |= Input.GetKeyDown(KeyCode.Slash);
        }
